...
export const reconstruction = (endNode) => {
  const path = [];
  ...
  // If no path exists return an empty arrqy
  if (!temp.previous && !temp.isStart) return [];
...
export const dijkstrasDescription = (
    <div>
...
export const algoInfo = {
    1: {
      ...
      description: Astar,
      image: "public/AstarExampleEn.gif",
    },
    2: {
      title: "Dijkstra's Algorithm",
      description: dijkstrasDescription,
      image: "/public/Dijkstra_Animation.gif",
    },
    3: {
      title: "Breadth First Search",
      description: bfsDescription,
      image: "public/Animated_BFS.gif",
    },
    4: {
      title: "Depth First Search",
      description: dfsDescription,
      image: "public/Depth_First_Search.gif",
    },
  };
